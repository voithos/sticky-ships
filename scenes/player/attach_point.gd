...
func _ready() -> void:
	_update_radius()
	Global.level.leveled_up.connect(_update_radius)
...
func _update_radius() -> void:
	$CollisionShape2D.shape.radius = ATTACH_POINT_DEFAULT_RADIUS * Global.get_growth_level_scale(Session.current_growth_level)
